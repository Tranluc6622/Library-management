...
public class UserCustomizeRepository {
    ...
    public UserCustomizeRepository(EntityManagerFactory factory) {
        if(factory.unwrap(SessionFactory.class) == null)
            throw new NullPointerException("factory i   xs not a hibernate factory");
    ...
    public User findByUsername(String username)
    {
        ...
        Object result = null;
        try{
            Query query = session.createNativeQuery("select * from lb_user.user where username = ?", User.class);
